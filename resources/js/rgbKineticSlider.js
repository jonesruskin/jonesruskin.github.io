(function() {
    ...
    window.rgbKineticSlider = function(options) {
        ...
        function build_imgs() {
            ...
            slideImage = imagesContainer.children;
        }
                ...
                if( options.textsDisplay == true) {
                    ...
                    for (let i = 0; i < options.itemsTitles.length; i++) {
                        ...
                        if(options.buttonMode == true) {
                            ...
                            textTitles.interactive = false;
                            textTitles.buttonMode = false;
                    ...
                    if( options.textsSubTitleDisplay == true) {
                        ...
                        for (let i = 0; i < options.itemsTitles.length; i++) {
                            ...
                            if(options.buttonMode == true) {
                                ...
                                textTitles2.interactive = true;
                                textTitles2.buttonMode = true;
    
                                // Pointers normalize touch and mouse
                                textTitles2.on('pointerdown', onClick);
        ...
        function slideTransition(next) {
            ...
            if( (options.textsSubTitleDisplay  == true) && (options.textsDisplay == true) && (options.itemsTitles.length > 0) ) {
                ...
                timelineTransition
                    ...
                    .to([slideImage[currentIndex], slideTexts[currentIndex], slideTextsSub[currentIndex]], options.slideTransitionDuration, {
                            alpha: 0,
                            ease: Power2.easeOut
                        }, options.slideTransitionDuration * 0.5)
                    .to([slideImage[next], slideTexts[next], slideTextsSub[next]], options.slideTransitionDuration, {
                            alpha: 1,
                            ease: Power2.easeOut
                        }, options.slideTransitionDuration * 0.5)
                    .to(dispFilter.scale, options.slideTransitionDuration, {
            ...
            // if subtitles inactive and title active
                ...
                timelineTransition
                    ...
                    .to([slideImage[currentIndex], slideTexts[currentIndex]], options.slideTransitionDuration, {
                            alpha: 0,
                            ease: Power2.easeOut
                        }, options.slideTransitionDuration * 0.5)
                    .to([slideImage[next], slideTexts[next]], options.slideTransitionDuration, {
                            alpha: 1,
                            ease: Power2.easeOut
                        }, options.slideTransitionDuration * 0.5)
                    .to(dispFilter.scale, options.slideTransitionDuration, {
                ...
                timelineTransition
                    ...
                    .to(slideImage,  options.slideTransitionDuration, {
                            alpha: 0,
                            ease: Power2.easeOut
                        }, options.slideTransitionDuration * 0.5)
                    .to([slideImage[next]], options.slideTransitionDuration, {
                            alpha: 1,
                            ease: Power2.easeOut
                        }, options.slideTransitionDuration * 0.5)
                    .to(dispFilter.scale, options.slideTransitionDuration, {
